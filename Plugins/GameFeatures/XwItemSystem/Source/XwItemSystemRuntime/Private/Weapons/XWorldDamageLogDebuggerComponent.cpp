...
#include UE_INLINE_GENERATED_CPP_BY_NAME(XWorldDamageLogDebuggerComponent)

UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Lyra_Damage_Message);

UXWorldDamageLogDebuggerComponent::UXWorldDamageLogDebuggerComponent(const FObjectInitializer& ObjectInitializer)
...
void UXWorldDamageLogDebuggerComponent::BeginPlay()
{
	Super::BeginPlay();
...
void UXWorldDamageLogDebuggerComponent::EndPlay(const EEndPlayReason::Type EndPlayReason)
{
	UGameplayMessageSubsystem& MessageSubsystem = UGameplayMessageSubsystem::Get(this);
...
void UXWorldDamageLogDebuggerComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void UXWorldDamageLogDebuggerComponent::OnDamageMessage(FGameplayTag Channel, const FLyraVerbMessage& Payload)
{
