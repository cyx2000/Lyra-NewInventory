...
#include "XWorldWeaponInstance.h"
#include "AbilitySystem/LyraAbilitySourceInterface.h"

#include "XWorldRangedWeaponInstance.generated.h"

class UPhysicalMaterial;

/**
 * UXWorldRangedWeaponInstance
 *
 * A piece of equipment representing a ranged weapon spawned and applied to a pawn
 */
UCLASS()
class UXWorldRangedWeaponInstance : public UXWorldWeaponInstance, public ILyraAbilitySourceInterface
{
	GENERATED_BODY()

public:
	UXWorldRangedWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
public:
	...
	//~IXWorldAbilitySourceInterface interface
	...
	//~End of IXWorldAbilitySourceInterface interface
