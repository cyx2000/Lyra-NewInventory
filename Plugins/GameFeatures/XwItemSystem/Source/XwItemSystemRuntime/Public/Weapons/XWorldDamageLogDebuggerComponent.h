...
#include "XWorldDamageLogDebuggerComponent.generated.h"
...
class UXWorldDamageLogDebuggerComponent : public UActorComponent
{
	GENERATED_BODY()

public:

	UXWorldDamageLogDebuggerComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
